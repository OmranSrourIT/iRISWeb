                    ...
                    if (response.data.length > 0 && response.data != "IS_ERROR_UNOPEN(-1000000)R100_SDK_Sample_Device_C#") {
                        ...
                        if(response.data == "Error occurred")
                        {
                            ...
                            this.setState({
                                ...
                                ImageIRIS_Right: `./img/${this.props.ModuleName.value}$${this.props.ImageCollection.value}$Iris2Widget.jpg`,
                                ImageIRIS_Left: `./img/${this.props.ModuleName.value}$${this.props.ImageCollection.value}$Iris2Widget.jpg`,
                                ResponseMessageQuailityEyes: "حصل خطأ في الأتصال بالخادم",
                                DivMessgaBox: true,
                                QuiltyRight: "",
                                QuiltyLeft: "",
                                QialtyHide: false,
                            ...
                            if (response.data == this.state.ErrorFlag) {
                                ...
                                if (response.data[0].ImageQuailtyLeft != '0' && response.data[0].ImageQuailtyRight != '0') {
                                    ...
                                    if (response.data[0].MessageQuailty == 'Success,High quality') {
                                        ...
                                        } else if(response.data[0].ImageQuailtyRight == "1")
                                        {
                                            this.setState({
                                                DeqaIDRight: false,
                                                ImageIRIS_Right: `./img/${this.props.ModuleName.value}$${this.props.ImageCollection.value}$EyeContactlens.jpg`,
                                                QuiltyRight: response.data[0].ImageQuailtyRight,
                                                BlockedButtonSave : false,
                                                ResponseMessageQuailityEyes : "يوجد عدسات لاصقة للعين", 
                                            })
                                        ...
                                        }else if(response.data[0].ImageQuailtyLeft == "1")
                                        {
                                            this.setState({
                                                DeqaIDLeft: true,
                                                ImageIRIS_Left: `./img/${this.props.ModuleName.value}$${this.props.ImageCollection.value}$EyeContactlens.jpg`,
                                                QuiltyLeft: response.data[0].ImageQuailtyLeft,
                                                BlockedButtonSave : false,
                                                ResponseMessageQuailityEyes : "يوجد عدسات لاصقة للعين", 
                                            })
                ...
                <div class="row rowIrisEys">
                    ...
                    <div class="col-xs-4 col-sm-4 col-md-4">
                        <div className="img_camera">
                            ...
                            <img src={`./img/${this.props.ModuleName.value}$${this.props.ImageCollection.value}$loading_small.gif`} />
                            </div>) : ('')}
